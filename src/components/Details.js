    ...
    return (
        <div className='details'>
            ...
            <div className='details__items'>
                <div className='details__interior-exterior'>
                ...
                <label>Tallest Ladder Needed:</label>
                <select
                    type='select'
                ...
                <label>Price Per Standard Pane:</label>
                <CurrencyInput 
                ...
                />
                <label>Price Per French Pane:</label>
                <CurrencyInput
                ...
                />
                <label>Price Per Skylight:</label>
                <CurrencyInput
                ...
                />
                <label>Price Per Large Pane:</label>
                <CurrencyInput
